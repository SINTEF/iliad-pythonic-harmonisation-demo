...
They call low-level functions but remain RDFLib-free.
...
Example: `high_level_observation_functions.py` transforms raw sea-temperature JSON into OIM-aligned SOSA/QUDT RDF.
...
- `iliad_harmonisation_pipeline.ipynb` – Notebook version  
- `data/sea_temp.json` – Example input  
- `output/*.ttl` – Generated RDF  
- `utils.py`, `constants.py` – Supporting utilities
...
- `iliad_harmonisation_pipeline.ipynb` – Notebook version of the pipeline for interactive exploration.  
